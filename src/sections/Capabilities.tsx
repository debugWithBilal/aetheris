...
const services: { label: string; detail: string }[] = [
  { label: 'Cliff Residences', detail: 'Six unique sanctuaries from 42m² studios to 350m² estates' },
  { label: 'Sea Spa & Thermal', detail: 'Seawater hydrotherapy circuit and marine mineral treatments' },
  { label: 'Coastal Gastronomy', detail: 'Two restaurants, private chef experiences, day-boat catch' },
  { label: 'Infinity Horizon Pool', detail: '25m cliff-edge pool, private cabanas, sunset lounge' },
  { label: 'Yacht & Excursions', detail: 'Private charters, hidden coves, and coastal exploration' },
  { label: 'Cliffside Events', detail: 'Intimate ceremonies and celebrations for up to 80 guests' },
  { label: 'Residence Concierge', detail: 'Dedicated keeper, bespoke itineraries, private dining' },
  { label: 'Seamless Arrival', detail: 'Chauffeured transfers from regional airports and marinas' },
]
      ...
      >
        ...
        >
          <div style={{ flex: '1 1 500px' }}>
            ...
            >
              From sunrise coffee on your private terrace to a midnight soak 
              under the stars, every moment at AETHERIS is quietly composed. 
              A selection of what awaits every guest:
            </p>
          </div>
          <div
            style={{
...
function OrbitalBadge() {
  ...
  useEffect(() => {
    ...
    const textContent = 'AETHERIS \u2022 AEGEAN SANCTUARY \u2022 EST. 2004 \u2022 '
